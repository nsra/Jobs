...
@section("content")
<form action="/company/job" class="form-horizontal" method="post">
    {{csrf_field()}}
          <div class="form-group">
            <label for="title" class="col-sm-2 control-label">العنوان</label>
            <div class="col-sm-10">
              <input autofocus type="text" value="{{old("title")}}" class="form-control" name="title" placeholder="عنوان الوظيفة">
            </div>
          </div>
    ...
    <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" rows="5" name="details" placeholder="تفاصيل الوظيفة">{{old("details")}}</textarea>
            </div>
          </div>
    ...
    <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <option value="">نوع الدوام</option>
                    ...
                    <option {{old("job_type_id")==$j->id?"selected":""}} value="{{$j->id}}">{{$j->name}}</option>
                    @endforeach
                </select>
                </div>
                </div>
