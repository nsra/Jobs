...
<html lang="en" dir="rtl">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Jobs | الشركات  | @yield("title")</title>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <a href="/company/home/changepassword">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item start ">
                            <a href="/company/job" class="nav-link nav-toggle">
                                <i class="icon-list"></i>
                                <span class="title">الوظائف  </span>
                            </a>
                        </li>
                        <li class="nav-item start ">
                            <a href="/company/job/create" class="nav-link nav-toggle">
                                <i class="icon-plus"></i>
                                <span class="title">اضافة وظيفة جديدة  </span>
                            </a>
                        </li>
